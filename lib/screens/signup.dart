...
class SignupScreen extends StatelessWidget {
              ...
              child: GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Create your silhouette with Lave.',
                      style: TextStyle(color: AppColors.onSurfaceVariant, fontSize: 14),
                    ),
                    const SizedBox(height: 32),
                    _buildInputGroup('FULL NAME', 'Aurelius Thorne'),
  ...
  Widget _buildSignupButton(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () => Navigator.pushReplacementNamed(context, '/setup_personal'),
  ...
  Widget _buildFooter(BuildContext context) {
    return Row(
      ...
      children: [
        const Text('ALREADY HAVE AN ACCOUNT? ', style: TextStyle(color: AppColors.onSurfaceVariant, fontSize: 12, fontWeight: FontWeight.bold)),
        GestureDetector(
          onTap: () => Navigator.pop(context),
          child: const Text('LOGIN', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, decoration: TextDecoration.underline)),
        ),
      ],
    );
  }
